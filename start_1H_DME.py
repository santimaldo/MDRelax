...
# nmr_H_group_intra = nmrmd.NMR(u, atom_group=H_bond, isotropic=True, actual_dt=dt, number_i=ni,
#                          type_analysis="intra_molecular", neighbor=H_group)
#

print("calculando total...")
nmr_H_bond= nmrmd.NMR(u, atom_group=H_bond, isotropic=True, actual_dt=dt, number_i=ni, neighbor=H_group)
...
print("calculando total...")
nmr_H_free = nmrmd.NMR(u, atom_group=H_free, isotropic=True, actual_dt=dt, number_i=ni, neighbor=H_group)
elapsed_time = time.time() - end_time
end_time = time.time()
